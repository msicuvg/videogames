...
public final class Entrada {
    ...
    private static Scanner scanner = new Scanner(System.in, charsetName);
     ...
     //Modificación agregada el 14 de noviembre
    public static void scannerFile(URL fileurl) throws IOException{
         InputStream in = fileurl.openStream();
         scanner = new Scanner(in);
    }

    //Modificación agregada el 14 de noviembre
    public static void scannerFile(String filename){
        try{
    ...
    public static void main(String[] args) {
        ...
        boolean b = Entrada.readBoolean();
        System.out.println("Your boolean was: " + b);
        System.out.println();

        System.out.println("Type a double: ");
        double c = Entrada.readDouble();
